...
namespace GradeBook.Tests
{
    ...
    public class TypeTests
    {
        ...
        private void GetBookSetName(ref InMemoryBook book, string name) // this is reference
        {
        ...
        public void CSharpIsPassByValueByDefault()
        {
            ...
            Assert.Equal("Book 1", book1.Name);
                ...
                private void GetBookSetName(InMemoryBook book, string name) // this is value
        {
            book = new InMemoryBook(name);
